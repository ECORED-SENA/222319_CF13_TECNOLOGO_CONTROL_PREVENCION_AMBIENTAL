export default {
  global: {
    ...
    descripcionCurso:
      'Con este componente formativo, se realizará el control operacional en los sistemas de tratamiento para los diferentes tipos de residuos, con el fin de conocer los tipos de materiales, las diferentes tecnologías y metodologías de reciclaje, tratamiento y/o disposición de los residuos, necesarias para identificar la mejor alternativa de gestión.',
